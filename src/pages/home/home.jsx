...
import { Calendar, Ticket, Music, Tv, Globe, Star, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="container mx-auto px-4 py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-gray-800">Why Choose TicketMaster</h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow group">
              <div className="h-40 bg-blue-500 flex items-center justify-center group-hover:bg-blue-600 transition-colors">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow group">
              <div className="h-40 bg-red-500 flex items-center justify-center group-hover:bg-red-600 transition-colors">
                <Tv size={48} className="text-white" />
              </div>
              <div className="p-4">
                <h3 className="font-bold text-lg text-center">Theater</h3>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow group">
              <div className="h-40 bg-green-500 flex items-center justify-center group-hover:bg-green-600 transition-colors">
                <Globe size={48} className="text-white" />
              </div>
              <div className="p-4">
                <h3 className="font-bold text-lg text-center">Sports</h3>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow group">
              ...
              <div className="p-4">
                <h3 className="font-bold text-lg text-center">Festivals</h3>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="bg-gradient-to-r from-blue-800 to-indigo-800 rounded-2xl p-12 text-white text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <Link to="/signup" className="bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold py-4 px-8 rounded-lg text-lg transition-colors">
              Create Account
            </Link>
            <Link to="/browse" className="border-2 border-white hover:bg-white hover:text-blue-900 text-white font-bold py-4 px-8 rounded-lg text-lg transition-colors">
              Browse Events
            </Link>
          </div>
        </div>
