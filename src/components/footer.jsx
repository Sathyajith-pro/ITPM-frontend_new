      ...
      <footer className="bg-gradient-to-r from-gray-900 to-blue-900 text-white pt-12 pb-6 flex ">
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/4 mb-8">
              <div className="flex items-center mb-4">
                <img 
                  ...
                  className="w-12 h-12 object-cover rounded-full border-2 border-white shadow-md mr-3"
                />
                <h2 className="text-xl font-bold">TicketMaster</h2>
              </div>
            ...
            <div className="w-full md:w-1/4 mb-8">
              ...
              <div className="mt-6">
                ...
                <p className="text-blue-200 text-sm">1234 Ticket Street, Event City</p>
                <p className="text-blue-200 text-sm">support@ticketmaster.com</p>
          ...
          <div className="border-t border-blue-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-blue-300 text-sm">© 2025 TicketMaster. All rights reserved.</p>
            <div className="flex space-x-4 mt-4 md:mt-0">
              <div className="flex items-center">
                <img src="/secure-payment.png" alt="Secure Payment" className="h-6 w-auto mr-2" />
                <span className="text-blue-300 text-xs">Secure Payment</span>
              </div>
              <div className="flex items-center">
                <img src="/24-support.png" alt="24/7 Support" className="h-6 w-auto mr-2" />
